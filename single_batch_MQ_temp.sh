...
do
    ...
    do
        echo 'SDS'$VAR
        out/SDS_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/MQ2007/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/MQ2007/1m.txt -maxLeaves $LEAF
    done
    echo
done
