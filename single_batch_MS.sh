...
# MSLR
# Set F
sed -i "s/#define F.*/#define F 15 \/\/ d/g" src/SDSD_StructPlus1.c
sed -i "s/#define F.*/#define F 30 \/\/ d/g" src/SDSD_StructPlus2.c
sed -i "s/#define F.*/#define F 1928 \/\/ d/g" src/SDSD_StructPlus3.c
sed -i "s/#define F.*/#define F 3856 \/\/ d/g" src/SDSD_StructPlus4.c
sed -i "s/#define F.*/#define F 7713 \/\/ d/g" src/SDSD_StructPlus5.c
sed -i "s/#define F.*/#define F 15427 \/\/ d/g" src/SDSD_StructPlus6.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/SDSD_StructPlus7.c

sed -i "s/#define F.*/#define F 15 \/\/ d/g" src/DSDS_StructPlus1.c
sed -i "s/#define F.*/#define F 3856 \/\/ d/g" src/DSDS_StructPlus2.c
sed -i "s/#define F.*/#define F 1928 \/\/ d/g" src/DSDS_StructPlus3.c
sed -i "s/#define F.*/#define F 15427 \/\/ d/g" src/DSDS_StructPlus4.c
sed -i "s/#define F.*/#define F 7713 \/\/ d/g" src/DSDS_StructPlus5.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/DSDS_StructPlus6.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/DSDS_StructPlus7.c

sed -i "s/#define F.*/#define F 30 \/\/ d/g" src/DSD_StructPlus1.c
sed -i "s/#define F.*/#define F 1928 \/\/ d/g" src/DSD_StructPlus2.c
sed -i "s/#define F.*/#define F 15427 \/\/ d/g" src/DSD_StructPlus3.c
...
do
    ...
    do
        echo 'SDS'$VAR
        out/SDS_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/MSLR/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/MSLR/100k.txt -maxLeaves $LEAF
    done

    for VAR in 1 2 3 4
    do
        echo 'DSD'$VAR
        out/DSD_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/MSLR/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/MSLR/100k.txt -maxLeaves $LEAF
    done
    echo
done
