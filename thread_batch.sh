...
# MQ2007
# Set F
sed -i "s/#define F.*/#define F 44 \/\/ d/g" src/ThreadSDSD_StructPlus1.c
sed -i "s/#define F.*/#define F 89 \/\/ d/g" src/ThreadSDSD_StructPlus2.c
sed -i "s/#define F.*/#define F 5720 \/\/ d/g" src/ThreadSDSD_StructPlus3.c
sed -i "s/#define F.*/#define F 11441 \/\/ d/g" src/ThreadSDSD_StructPlus4.c
sed -i "s/#define F.*/#define F 22882 \/\/ d/g" src/ThreadSDSD_StructPlus5.c
sed -i "s/#define F.*/#define F 45765 \/\/ d/g" src/ThreadSDSD_StructPlus6.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/ThreadSDSD_StructPlus7.c

sed -i "s/#define F.*/#define F 44 \/\/ d/g" src/ThreadDSDS_StructPlus1.c
sed -i "s/#define F.*/#define F 11441 \/\/ d/g" src/ThreadDSDS_StructPlus2.c
sed -i "s/#define F.*/#define F 5720 \/\/ d/g" src/ThreadDSDS_StructPlus3.c
sed -i "s/#define F.*/#define F 45765 \/\/ d/g" src/ThreadDSDS_StructPlus4.c
sed -i "s/#define F.*/#define F 22882 \/\/ d/g" src/ThreadDSDS_StructPlus5.c
...
sed -i "s/#define F.*/#define F 89 \/\/ d/g" src/ThreadDSD_StructPlus1.c
sed -i "s/#define F.*/#define F 11441 \/\/ d/g" src/ThreadDSD_StructPlus2.c
sed -i "s/#define F.*/#define F 45765 \/\/ d/g" src/ThreadDSD_StructPlus3.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/ThreadDSD_StructPlus4.c
comment

# Yahoo
# Set F
sed -i "s/#define F.*/#define F 3 \/\/ d/g" src/ThreadSDSD_StructPlus1.c
sed -i "s/#define F.*/#define F 5 \/\/ d/g" src/ThreadSDSD_StructPlus2.c
sed -i "s/#define F.*/#define F 373 \/\/ d/g" src/ThreadSDSD_StructPlus3.c
sed -i "s/#define F.*/#define F 747 \/\/ d/g" src/ThreadSDSD_StructPlus4.c
sed -i "s/#define F.*/#define F 1121 \/\/ d/g" src/ThreadSDSD_StructPlus5.c
sed -i "s/#define F.*/#define F 1494 \/\/ d/g" src/ThreadSDSD_StructPlus6.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/ThreadSDSD_StructPlus7.c

sed -i "s/#define F.*/#define F 3 \/\/ d/g" src/ThreadDSDS_StructPlus1.c
sed -i "s/#define F.*/#define F 747 \/\/ d/g" src/ThreadDSDS_StructPlus2.c
sed -i "s/#define F.*/#define F 373 \/\/ d/g" src/ThreadDSDS_StructPlus3.c
sed -i "s/#define F.*/#define F 747 \/\/ d/g" src/ThreadDSDS_StructPlus4.c
sed -i "s/#define F.*/#define F 373 \/\/ d/g" src/ThreadDSDS_StructPlus5.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/ThreadDSDS_StructPlus6.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/ThreadDSDS_StructPlus7.c

sed -i "s/#define F.*/#define F 5 \/\/ d/g" src/ThreadDSD_StructPlus1.c
sed -i "s/#define F.*/#define F 747 \/\/ d/g" src/ThreadDSD_StructPlus2.c
sed -i "s/#define F.*/#define F 1494 \/\/ d/g" src/ThreadDSD_StructPlus3.c
sed -i "s/#define F.*/#define F 100000 \/\/ d/g" src/ThreadDSD_StructPlus4.c
...
do
    ...
    do
        echo 'SDSD'$VAR
        out/ThreadSDSD_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/yahoo/xin/leaf_$LEAF/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/yahoo/400k.txt -maxLeaves $LEAF
    done
    for VAR in 1 2 3 4 5 6 7
    do
        echo 'DSDS'$VAR
        out/ThreadDSDS_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/yahoo/xin/leaf_$LEAF/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/yahoo/400k.txt -maxLeaves $LEAF
    done

    for VAR in 1 2 3 4
    do
        echo 'SDS'$VAR
        out/ThreadSDS_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/yahoo/xin/leaf_$LEAF/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/yahoo/400k.txt -maxLeaves $LEAF
    done

    for VAR in 1 2 3 4
    do
        echo 'DSD'$VAR
        out/ThreadDSD_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/yahoo/xin/leaf_$LEAF/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/yahoo/400k.txt -maxLeaves $LEAF
    done
    echo
done
