...
do
    ...
    echo 'SDSD3'
    out/SDSD_StructPlus3 -ensemble /home/xin_jin/fast_rank/tree_model/MQ2007/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/MQ2007/1.txt -maxLeaves $LEAF
    echo
done
