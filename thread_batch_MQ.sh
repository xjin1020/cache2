...
sed -i "s/#define F.*/#define F 17162 \/\/ d/g" src/ThreadSDSD_StructPlus5.c
sed -i "s/#define F.*/#define F 22882 \/\/ d/g" src/ThreadSDSD_StructPlus6.c
...
sed -i "s/#define F.*/#define F 11441 \/\/ d/g" src/ThreadDSDS_StructPlus4.c
sed -i "s/#define F.*/#define F 5720 \/\/ d/g" src/ThreadDSDS_StructPlus5.c
...
sed -i "s/#define F.*/#define F 22882 \/\/ d/g" src/ThreadDSD_StructPlus3.c
...
do
    ...
    do
        echo 'SDSD'$VAR
        out/ThreadSDSD_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/MQ2007/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/MQ2007/400k.txt -maxLeaves $LEAF
    done
    for VAR in 1 2 3 4 5 6 7
    do
        echo 'DSDS'$VAR
        out/ThreadDSDS_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/MQ2007/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/MQ2007/400k.txt -maxLeaves $LEAF
    done

    for VAR in 1 2 3 4
    do
        echo 'SDS'$VAR
        out/ThreadSDS_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/MQ2007/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/MQ2007/400k.txt -maxLeaves $LEAF
    done

    for VAR in 1 2 3 4
    do
        echo 'DSD'$VAR
        out/ThreadDSD_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/MQ2007/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/MQ2007/400k.txt -maxLeaves $LEAF
    done
    echo
done
