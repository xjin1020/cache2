...
# MQ2007
# Set F
sed -i "s/#define F.*/#define F 89 \/\/ d/g" src/SDSD_StructPlus8.c
sed -i "s/#define F.*/#define F 89 \/\/ d/g" src/SDSD_StructPlus9.c
sed -i "s/#define F.*/#define F 11441 \/\/ d/g" src/SDSD_StructPlus10.c

sed -i "s/#define F.*/#define F 45765 \/\/ d/g" src/DSDS_StructPlus8.c
