...
END
sed -i "s/#define F.*/#define F 178 \/\/ d/g" src/DSD_StructPlus1.c
sed -i "s/#define F.*/#define F 22882 \/\/ d/g" src/DSD_StructPlus2.c
sed -i "s/#define F.*/#define F 91530 \/\/ d/g" src/DSD_StructPlus3.c
sed -i "s/#define F.*/#define F 200000 \/\/ d/g" src/DSD_StructPlus4.c
...
END
    ...
    do
        echo 'DSD'$VAR
        out/DSD_StructPlus$VAR -ensemble /home/xin_jin/fast_rank/tree_model/23features/tree-ensemble-file_20000_$LEAF -instances /home/xin_jin/fast_rank/input/23features/200k.txt -maxLeaves $LEAF
    done
    echo
done
